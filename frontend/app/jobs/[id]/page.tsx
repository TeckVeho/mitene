...
import { Download, RefreshCw, ArrowLeft, FileSpreadsheet, Loader2 } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-5">
        ...
        <Card className="border-border md:col-span-2">
          ...
          <CardContent className="space-y-0 divide-y divide-border">
            <DetailRow label="スタイル" value={VIDEO_STYLE_LABELS[job.style].label} />
            <DetailRow label="フォーマット" value={job.format === "explainer" ? "解説型" : "短縮版"} />
